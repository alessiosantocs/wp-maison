...
function html5blank_nav($menu_class="")
{
    wp_nav_menu(
    array(
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        if (HTML5_DEBUG) {
            ...
            // Bootstrap
            wp_register_script('bootstrap', get_template_directory_uri() . '/js/lib/bootstrap.min.js', array(), '3.3.5');

            // Slick
            wp_register_script('slick', get_template_directory_uri() . '/js/lib/slick.min.js', array(), '1.5.7');

            // Datepicker
            wp_register_script('tp-datepicker', get_template_directory_uri() . '/js/lib/tp-daterangepicker.js');
            ...
            // Enqueue Scripts
            wp_enqueue_script('maison_scripts');
...
add_filter('body_class', 'add_page_layout_classes_to_body_class'); // Add page layout special classes to body class
...
require_once "modules/bnb-apartments.php";
